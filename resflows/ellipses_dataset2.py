...
def pair_generator(ray_trafo, seed=None, noise_stddev=0.05, noise_seed=None):
...
#    options are 'astra_cpu' and 'skimage'
    ...
    # (a,b) = next(pair_generator(ray_trafo))
    # a.show(force_show=True)
    # b.show(force_show=True)
